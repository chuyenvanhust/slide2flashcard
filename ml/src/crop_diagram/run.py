...
def test_crop_module():
    ...
    PDF_TEST = r"C:\Users\trumx\Downloads\Thầy Trần Việt Trung-20260311T032147Z-3-001\Thầy Trần Việt Trung\4.6_presto.pdf"
    OUTPUT_DIR = "ml/outputs/test_crops_19"
    # Cập nhật đường dẫn model mới


    MODEL_PATH = r"C:\Users\trumx\slide2flashcard\ml\src\crop_diagram\models\train_results_20260623_114655\weights\best.pt"
    ...
    results = cropper.run(PDF_TEST, output_base_dir=OUTPUT_DIR,top_k=1000)
